...
/usr/bin/pacman -Sy --noconfirm numactl kornrunner/mysql kornrunner/mysql-clients kornrunner/libmysqlclient expect
sync
...
sed "s/sql_mode=/# sql_mode=/" -i /etc/mysql/my.cnf
sync
